...
export const Form = ({type, register, handleImageChange, formLoading, onFinishHandler, propertyImage, handleSubmit}: FormProps) => {
  return (
    <Box>
        ...
        >
          ...
          <Stack direction="row" gap={4}>
              <FormControl sx={{ flex: 1 }}>
                ...
                >
                  ...
                  <MenuItem value="dublex">Dublex</MenuItem>
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            <Stack direction="row" gap={2}>
              <Typography fontSize={16} fontWeight={500} color="#11142d" my="100px">Property Photo</Typography>
